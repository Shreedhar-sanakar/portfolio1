      ...
      <div className="row firstRow">
        <div className="col-lg-6">
          <div className="aboutDiv">
            <p className="title1"><span style={{color:"tomato"}}> Hi, </span>I'm SHREEDHAR</p>
            ...
            <a href="https://drive.google.com/file/d/1VH5w15nl83pVptQ3LUXumGKhQQVo2ORr/view?usp=sharing" target="blank" className="anchor" style={{color:"black"}}>
